...
class AuthService {
  static Future<Map<String, dynamic>> login({
    ...
    final url = Uri.parse('https://www.signdoc-core.io.vn/api/Authentication/view-sign-in');
  ...
  static Future<void> sendOtp({required String email}) async {
    final url = Uri.parse('https://www.signdoc-core.io.vn/api/Authentication/create-send-otp?email=$email');
  ...
  static Future<VerifyOtpResponse> verifyOtp({
    ...
    final url = Uri.parse('https://www.signdoc-core.io.vn/api/Authentication/create-verify-otp');
  ...
  static Future<ChangePasswordResponse> changeForgotPassword({
    ...
    final url = Uri.parse('https://www.signdoc-core.io.vn/api/Authentication/create-forgot-password');
  ...
  static Future<ChangePasswordResponse> changePassword({
    ...
    final url = Uri.parse('https://www.signdoc-core.io.vn/api/Authentication/create-change-password');
