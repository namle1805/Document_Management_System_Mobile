...
class DocumentService {
  static const String baseUrl = 'https://www.signdoc-core.io.vn';
  ...
  Future<List<DocumentModel>> fetchDocuments(String workFlowId, String documentTypeId) async {
    ...
    final response = await http.get(
        Uri.parse("https://www.signdoc-core.io.vn/api/Document/view-all-documents-mobile?workFlowId=$workFlowId&documentTypeId=$documentTypeId"),
        headers: {
  ...
  Future<List<DocumentModel>> fetchDocumentsHome(String documentType) async {
    final response = await http.get(
        Uri.parse("https://www.signdoc-core.io.vn/api/Document/view-all-documents-by-document-type-mobile?documentTypeId=$documentType"),
        headers: {
          "Authorization": 'Bearer ${UserManager().token}'
        }
    );
  ...
  Future<List<DocumentModel>> fetchSearchDocuments(String query) async {
    final response = await http.get(
        Uri.parse("https://www.signdoc-core.io.vn/api/Document/view-document-by-name?documentName=$query"),
        headers: {
          "Authorization": 'Bearer ${UserManager().token}'
        }
    );
  ...
  static Future<DocumentDetail?> fetchDocumentDetail({
    ...
    final url = Uri.parse(
      'https://www.signdoc-core.io.vn/api/Document/view-detail-documents-mobile'
