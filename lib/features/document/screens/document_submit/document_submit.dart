...
class ViewDocumentSubmitPage extends StatefulWidget {
  final String imageUrl;
  final String documentId;
  final String documentName;
  final String taskId;

  const ViewDocumentSubmitPage({
    super.key,
  ...
  @override
  State<ViewDocumentSubmitPage> createState() => _ViewDocumentSubmitPageState();
}

class _ViewDocumentSubmitPageState extends State<ViewDocumentSubmitPage> {
